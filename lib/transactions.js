...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.recryptd.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    isrrc20Transfer: transaction.isrrc20Transfer,
  };
...
TxController.prototype.transformRecryptTransaction = function(transaction) {
